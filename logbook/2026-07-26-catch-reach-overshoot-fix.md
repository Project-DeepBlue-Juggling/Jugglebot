...
`plans/archived/catch-reach-degenerate-overshoot.md` and the replay probe both stated
...
- `plans/archived/catch-reach-degenerate-overshoot.md` — the plan; Phase 2 Outcome.
