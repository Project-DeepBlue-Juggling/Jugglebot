...
Phase 1 of the [mpc-tier0-contracts plan](../plans/archived/mpc-tier0-contracts.md):
...
The plan ([mpc-tier0-contracts.md](../plans/archived/mpc-tier0-contracts.md)
...
| `plans/archived/mpc-tier0-contracts.md` | Phase 1 status: `NOT STARTED` → `IN PROGRESS (started 2026-05-09)` → `COMPLETE (2026-05-09)` |
