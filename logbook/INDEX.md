...
|------|--------|-------|-------|-------|
| 2026-04-20 | in-progress | post-per-leg-gains-deadband-session | Motion-onset dead-time — cogging-torque-first investigation | [2026-04-20-motion-onset-dead-time-fix](2026-04-20-motion-onset-dead-time-fix.md) |
