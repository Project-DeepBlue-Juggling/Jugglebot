...
3. **`plans/archived/catch-reach-degenerate-overshoot.md` Phase 4 (two lenses).** Its
...
- `plans/archived/catch-reach-degenerate-overshoot.md` — Phase 4 cell annotated, Phase 4
...
3. **`plans/archived/single-ball-toss.md` still records 8b as shipping behind
...
- `plans/archived/catch-reach-degenerate-overshoot.md` § Phase 4 — the plan phase this
  lands under.
- `plans/archived/single-ball-toss.md` § Phase 4 — where Tier 8b itself was implemented
  (2026-07-25).
