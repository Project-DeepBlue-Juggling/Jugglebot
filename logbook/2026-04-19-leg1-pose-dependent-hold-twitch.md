...
files_changed:
  ...
  - plans/archived/motion-onset-deadtime-investigation.md
...
- `plans/archived/motion-onset-deadtime-investigation.md` was authored during this investigation as an earlier sibling — motion-onset dead-time is a separate phenomenon (moves 1-4 of the 9-move rosbag) tracked there rather than here.
