#!/usr/bin/env python3
"""
generate_udp_protocol.py -- Single-source generator for the Jetson <-> leg-bridge
...
FIRMWARE_DIR = REPO_ROOT / "ros_ws" / "src" / "jugglebot" / "Teensy_code_legbridge"
...
def generate_cpp() -> str:
    ...
    a("// Jetson <-> leg-bridge Teensy UDP wire protocol.")
...
def generate_python() -> str:
    ...
    a('"""')
    a("AUTO-GENERATED by config/generate_udp_protocol.py — DO NOT EDIT")
    a("Jetson <-> leg-bridge Teensy UDP wire protocol (Python side).")
    a("See docs/teensy-udp-protocol.md. To regenerate: python config/generate_udp_protocol.py")
    a('"""')
...
def generate_markdown() -> str:
    L = []
    a = L.append
    a("# Jetson ↔ leg-bridge Teensy — UDP protocol")
    a("")
    ...
    a("and the new leg-bridge Teensy 4.1 (Phase 4 of `plans/active/teensy-can-offload.md`).")
    a("")
    a("## Framing")
    a("")
