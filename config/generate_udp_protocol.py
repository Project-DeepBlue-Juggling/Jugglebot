...
MESSAGES = [
    ...
    Message(
        ...
        summary=(
            ...
            "previous emit. Built for plans/active/bridge-temporal-"
            "trustworthiness.md P1; it is the raw material the clock plan's "
    ...
    Message(
        ...
        summary=(
            ...
            "therefore immune to whatever happens in the ring afterwards; (2) "
        ...
        fields=[
            ...
            Field("lag_now_us",          "i32", 1,
                  ...
                  "soak supplies that zero. THE TREND IS THE MEASUREMENT. "
                  "SIGNED because the FlexCAN timer and micros64() are separate dividers off the "
                  "same crystal, so a small constant rate ratio can drift this negative; a "
                  "fresh-boot soak also measures that artefact, and it is a straight line where "
                  "the leak is a ratchet"),
