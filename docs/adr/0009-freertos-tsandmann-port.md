...
- Inter-task communication uses FreeRTOS queues + semaphores; ISR↔task
  ...
  [`time_base.h`](https://github.com/Project-DeepBlue-Juggling/Jugglebot/blob/main/ros_ws/src/jugglebot/Teensy_code_canbridge/time_base.h)).
...
quirks differ; see
[`freertos_shim.h`](https://github.com/Project-DeepBlue-Juggling/Jugglebot/blob/main/ros_ws/src/jugglebot/Teensy_code_canbridge/freertos_shim.h).
...
- **C++ std::thread support drags in libstdc++ exception machinery**,
  ...
  [README](https://github.com/Project-DeepBlue-Juggling/Jugglebot/blob/main/ros_ws/src/jugglebot/Teensy_code_canbridge/README.md)
