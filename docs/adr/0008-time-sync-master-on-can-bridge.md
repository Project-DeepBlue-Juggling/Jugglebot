...
- **Related**: [ADR-0001](0001-offload-can-and-interpolator-from-jetson.md), [ADR-0009](0009-freertos-tsandmann-port.md), [ADR-0010](0010-onboard-clock-sufficient.md), [ADR-0013](0013-three-can-buses.md), [parent plan](../../plans/archived/teensy-can-offload.md)
