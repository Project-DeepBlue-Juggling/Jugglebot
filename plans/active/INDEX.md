...
| [refactor-2026-07.md](refactor-2026-07.md) | active | 2026-08-01 | 2026-07 refactor programme. Landed 2026-07-31/2026-08-01: Phases 0–3 (dead-weight sweep, process rules, nightly tier, MPC dormancy), 5 (partial — config drift gate), 6 slices 1–2 (analysis safety nets, structure cleanups), 7a (ERR_TIMEOUT recount). Phase 4 (teensy_link → repo root) software-landed — **its disarmed bench link-up smoke is OUTSTANDING**. Remaining: Phase 5 items 1/3, Phase 6 later slices, Phase 7 |
