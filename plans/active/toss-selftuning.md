...
```bash
ros2 topic echo /trajectory/status --once | grep -E 'gravity_correction_loaded|tilt_map_loaded|tilt_map_version|toss_cal_loaded|toss_cal_version|toss_cal_applied'
