...
**Status:** parked 2026-08-15 (moved into `plans/parked/` 2026-08-16 when the
board went three-way; Phases 0–4 landed; 5–7 partial — see the row in
`plans/parked/INDEX.md`, which names what would unpark this. The headline arc —
ERR_TIMEOUT — closed 2026-08-09 on
FW 10, and the bridge-uptime bullet was absorbed by
`plans/archived/bridge-temporal-trustworthiness.md` (closed
