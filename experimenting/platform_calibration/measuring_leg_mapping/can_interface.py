...
class CANInterface:
    ...
    # 10.701 rev is the hand's MEASURED metal contact (operator re-measurement,
    # 2026-09-06 — config/hardware_config.yaml jugglebot_geometry.
    # hand_motor_hard_stop_revs). This read 11.1 until 2026-08-21, then 10.8
    # until 2026-09-06 (FW 18 bundle), each correction moving the DECLARED
    # travel limit closer to the metal in a script that actuates the real
    # motor. It survived the 2026-08-18 sweep only because the symbol name
