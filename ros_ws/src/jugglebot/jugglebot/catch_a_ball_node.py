...
class CatchABallNode(Node):
    def __init__(self):
        super().__init__('catch_a_ball_node')
        ...
        self.catch_a_ball_enabled = False
    ...
    def control_mode_callback(self, msg):
        # If the incoming state calls for the catch_a_ball_node, enable it
        if msg.data == 'catch_a_ball_node' and not self.catch_a_ball_enabled:
            self.get_logger().info('catch_a_ball_node enabled')
            self.catch_a_ball_enabled = True

        elif msg.data != 'catch_a_ball_node' and self.catch_a_ball_enabled:
            self.get_logger().info('catch_a_ball_node disabled')
            self.catch_a_ball_enabled = False
    ...
    def predicted_landings_callback(self, msg: BallStateMulti):
        ...
        """
        # Check if the catch_a_ball control mode is enabled
        if not self.catch_a_ball_enabled:
            return
    ...
    def publish_catch_pose(self):
        ...
        message.publisher = 'catch_a_ball_node'
    ...
    def on_shutdown(self):
        ...
        """
        self.get_logger().info("Shutting down CatchABallNode...")
