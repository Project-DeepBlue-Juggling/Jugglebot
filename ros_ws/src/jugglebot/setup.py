...
# The toss AIM calibration map (jugglebot/motion/toss_cal.py) and its YAML
# branch were deleted 2026-09-13 (R3-f1, the learning-stack deletion) — see
# logbook/2026-09-13-skill-stack-r3-learner-single-site.md.
