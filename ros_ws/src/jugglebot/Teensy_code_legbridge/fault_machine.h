#pragma once
// =============================================================================
//  fault_machine.h — per-axis fault state machine + CAN2 watchdog + deferred stow
// =============================================================================
...
//    * CAN2 heartbeat watchdog + deferred-stow latch — can_node.py:1443-1530
//      (_watchdog_check) and 1098-1145 (_fault_response /
//      _actuators_intact_and_holding).
...
//    1. CAN2 down  ⇒ NEVER command the dead bus (interp output gated off; the
//       leg ODrives autonomously hold their last CLOSED_LOOP setpoint).
//    2. On CAN2 loss detection, ARM the deferred-stow latch.
