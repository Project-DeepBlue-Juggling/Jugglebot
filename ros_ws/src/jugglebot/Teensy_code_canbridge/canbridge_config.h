...
//  hand_source switch settle gate (hand_source.cpp). HAND_SETTLE_BAND_REV
//  mirrors motion/trajectory/hand_stroke.py:125 (0.10 rev — the settle band
//  the bench gates dip_below_x3 on; the plan § 2.4 names this constant for the
//  interlock). The velocity term makes "settled" mean NOT MOVING, not merely
//  near a rest: 0.5 rev/s = 16 mm/s, an order of magnitude under any stroke.
constexpr float    HAND_SETTLE_BAND_REV       = 0.10f;   // hand_stroke.py HAND_SETTLE_BAND_REV
constexpr float    HAND_SOURCE_SETTLE_VEL_RPS = 0.5f;
