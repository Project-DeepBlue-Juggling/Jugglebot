...
class PlatformPlotter(Node):
    ...
    def handle_geometry_response(self, future):
        ...
        if response is not None:
            ...
            self.get_logger().debug('EXAMPLE DEBUG MESSAGE')
            self.get_logger().info('EXAMPLE INFO MESSAGE')
            self.get_logger().warning('EXAMPLE WARNING MESSAGE')
            self.get_logger().error('EXAMPLE ERROR MESSAGE')
            self.get_logger().fatal('EXAMPLE FATAL MESSAGE')
