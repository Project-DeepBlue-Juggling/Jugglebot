...
> `plans/archived/catch-reach-degenerate-overshoot.md` and the replay probe both
...
neither column and disagreed with `plans/archived/catch-reach-degenerate-overshoot.md`
...
- `ros_ws/docs/levelling_frame.md` — C-LEVEL-1, the sibling contract that made
  this premise false.
- `plans/archived/catch-reach-degenerate-overshoot.md` — the investigation.
