...
def build_phase5_test_trajectories(geom: StewartGeometry = None,
    ...
    trajs.append(('T5: Active -> 30mm Z + 3deg X',
                  rest_to_rest(t5_end, 1.5)))
    trajs.append(('T5: 30mm Z + 3deg X -> Active',
    ...
    trajs.append(('T7: Active -> 15,-10,30mm + 3deg X',
                  rest_to_rest(t7_end, 1.5)))
    trajs.append(('T7: 15,-10,30mm + 3deg X -> Active',
