...
class TestHandleMessage:
    ...
    # Catching cone tests (catch-event routing, cone heartbeat routing +
    # connected gate) removed — cone RX (CAN 0x7E0/0x7E1) moved to the
    # can-bridge Teensy in the phase-10b cone uplink. Coverage now lives in
    # tests/ros/test_teensy_bridge_node_cone.py against the CONE_FRAME path.
