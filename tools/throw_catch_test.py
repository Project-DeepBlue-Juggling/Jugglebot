...
def run_throw_catch(
    ...
    # Platform needs ~0.8s to reach the throw position from home.
    ...
    home_pose = np.array([0.0, 0.0, float(hw.JB_OP_DEFAULT_ACTIVE_Z_MM),
                          0.0, 0.0, 0.0])
    traj_mgr.set_hold_pose(home_pose)
